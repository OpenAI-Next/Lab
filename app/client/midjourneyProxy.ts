...
export class DrawAPI {
  ...
  async submitDescribeTask(
    config: MidjourneyDescribeTaskRequestPayload,
    signal?: AbortSignal,
  ...
  async submitBlendTask(
    config: MidjourneyBlendTaskConfigType,
    signal?: AbortSignal,
    timeoutMs: number = REQUEST_TIMEOUT_MS,
  ) {
    try {
  ...
  async submitShortenTask(
    config: MidjourneyShortenTaskRequestPayload,
    signal?: AbortSignal,
    timeoutMs: number = REQUEST_TIMEOUT_MS,
  ) {
    try {
  ...
  async submitActionTask(
    config: MidjourneyDoActionQueryType,
    signal?: AbortSignal,
    timeoutMs: number = REQUEST_TIMEOUT_MS,
  ) {
    try {
  ...
  async submitModalTask(
    config: MidjourneyModalTaskRequestPayload,
    signal?: AbortSignal,
    timeoutMs: number = REQUEST_TIMEOUT_MS,
  ) {
    try {
  ...
  async fetchTask(
    config: MidjourneyFetchTaskRequestPayload,
    signal?: AbortSignal,
    timeoutMs: number = REQUEST_TIMEOUT_MS,
  ) {
    try {
  ...
  async getTaskSeed(
    config: MidjourneyGetSeedRequestPayload,
    signal?: AbortSignal,
    timeoutMs: number = REQUEST_TIMEOUT_MS,
  ) {
    try {
