    ...
    return (
        ...
        >
            ...
            <ProFormTextArea
                ...
                rules={[
                    {required: true},
                    {type: "string", max: differentModelsDetail[selectedModel].PromptMaxLength}
                ]}
            ...
            <ProFormSelect
                ...
                rules={[{required: false}]}
                tooltip={"The format in which the generated images are returned. URLs are only valid for 60 minutes after the image has been generated. Default to url."}
            />
            <ProFormDigit
                name={"n"}
                label={"N"}
            ...
            <ProFormSelect
                ...
                rules={[
                    {required: false}, {type: "enum", enum: differentModelsDetail[selectedModel].SizeOptions}
                ]}
            />
            {selectedModel === "dall-e-3" && <>
                <ProFormSelect
                    ...
                    label={"Quality"}
                    options={["hd", "standard"]}
                    tooltip={"The quality of the image that will be generated. hd creates images with finer details and greater consistency across the image. This param is only supported for dall-e-3."}
                />
                ...
                <ProFormSelect
                    ...
                    tooltip={"The style of the generated images. Must be one of vivid or natural. Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes the model to produce more natural, less hyper-real looking images. This param is only supported for dall-e-3."}
                />
            </>}
            <ProFormText
                name={"user"}
    ...
    return (
        ...
        >
            ...
            <ProFormUploadButton
                name={"image"}
                label={"Image"}
                tooltip={"The image to use as the basis for the variation(s). Must be a valid PNG file, less than 4MB, and square."}
                rules={[{required: true}]}
                accept={"image/png"}
                fieldProps={{
                    multiple: false,
            ...
            <ProFormUploadButton
                name={"mask"}
                label={"Mask"}
                tooltip={"An additional image whose fully transparent areas (e.g. where alpha is zero) indicate where image should be edited. Must be a valid PNG file, less than 4MB, and have the same dimensions as image."}
                accept={"image/png"}
                fieldProps={{
                    multiple: false,
                    beforeUpload: (file: Blob) => {
            ...
            <ProFormSelect
                ...
                tooltip={"The size of the generated images. Default to 1024x1024."}
                rules={[
                    {required: false}, {type: "enum", enum: ["256x256", "512x512", "1024x1024"]}
                ]}
            />
