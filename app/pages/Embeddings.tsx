...
const EmbeddingsForm = (props: {
    ...
    return (
        ...
        >
            ...
            {inputType === "string" && <ProFormTextArea
                name="input"
                label="Input"
                fieldProps={{
                    maxLength: 8192,
            ...
            {inputType === "array" && <ProFormTextArea
                name="input"
                label="Input"
                fieldProps={{
                    autoSize: {minRows: 3, maxRows: 7}
            ...
            <ProFormDigit
                name={"dimensions"}
                label={"Dimensions"}
                tooltip={"The number of dimensions the resulting output embeddings should have. Only supported in text-embedding-3 and later models."}
                rules={[{required: false}]}
            />
    ...
    return (
        <>
            ...
            <Col flex="auto" style={COL_SCROLL_STYLE}>
                <h1>Response</h1>
                {data && <>
                    {renderCode(safeJsonStringify(data, data.toString()))}
                </>}
                {errorData && <>
                    <h1>Error</h1>
