...
const TokenizerComponent = () => {
    ...
    const copyTokenLength = async () => {
        ...
        if (ok) {
            message.success({content: "copied !", key: "copyTokenLength", duration: 1});
        } else {
            message.error({content: "failed to copy !", key: "copyTokenLength", duration: 1});
        }
    }
        ...
        <Space direction={"vertical"} style={{width: "100%"}}>
            <Space>
                <Select
                    ...
                    options={ENCODING_TYPES.map((value) => ({label: value, value: value}))}
                    style={{width: 140}}
                    allowClear={false}
                />
                <InputNumber
...
const PriceCalculationComponent = () => {
    ...
    const [finalPrice, setFinalPrice] = useState(0.000000)
...
const RatioCalculationComponent = () => {
    ...
    const [finalRatios, setFinalRatios] = useState({model_ratio: 0.000, completion_ratio: 0.000})
